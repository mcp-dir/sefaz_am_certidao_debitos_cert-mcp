...
SEFAZ AM: Certidão Negativa de Débitos (Certificado Digital) segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [sefaz_am_certidao_debitos_cert@mcp.ai](mailto:sefaz_am_certidao_debitos_cert@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
